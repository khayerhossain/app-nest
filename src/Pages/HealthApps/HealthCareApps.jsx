...
const healthsAppPromise = fetch("Apps_Data.json")
    .then((res) => res.json())
const HealthCareApps = () => {
     const healthsAppData=use(healthsAppPromise);
     const healthApps = healthsAppData.filter(app => app.category === "Health & Fitness");
    return (
        <div className='mt-10 lg:mt-20'>
        <h2 className='text-2xl font-bold mb-6 ml-5 lg:ml-12'>Health And Fitness Apps</h2>
