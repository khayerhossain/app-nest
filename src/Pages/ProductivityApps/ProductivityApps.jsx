...
const productivityAppsPromise = fetch("Apps_Data.json")
    .then((res) => res.json())
const ProductivityApps = () => {
    const productivityData=use(productivityAppsPromise);
    const productivityApps = productivityData.filter(app => app.category === "Productivity");
    return (
 <div className='mt-10 lg:mt-20'>
    <h2 className='text-2xl font-bold mb-6 ml-5 lg:ml-12'>Productivity Apps</h2>
